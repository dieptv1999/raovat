import {
    OBJECT_TYPE, HOUSEHOLD_GOOD_TYPE,
    TYPE_OF_POST,
} from "../../utils/constant";
...
export default function HouseholdGood({
                                                          onSubmit = () => {
                                                          },
                                                          formik,
                                                      }) {
    ...
    const getBrand = () => {
        if (values.sub_collection && values.sub_collection !== -1) {
            const brand = find(HOUSEHOLD_GOOD_TYPE, e => e.name === values.sub_collection)?.brand
    ...
    return (
        <div>
                ...
                <div className="input-area">
                    ...
                    <div className="mb-5">
                        ...
                        <div className="text-sm text-gray-400 border border-gray-300
                             ...
                             onClick={() => {
                                 if (document) {
                                     document.getElementById("modal-select-address-11").showModal();
                                 }
                             }}>
            ...
            <SelectAddress id={'modal-select-address-11'} onSubmitAddress={addr => {
