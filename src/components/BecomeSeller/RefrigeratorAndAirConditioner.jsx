import {
    OBJECT_TYPE, REFRIGERATOR_AIR_CONDITIONER_TYPE,
    TYPE_OF_POST,
} from "../../utils/constant";
...
export default function RefrigeratorAndAirConditioner({
                                 onSubmit = () => {
                                 },
                                 formik,
                             }) {
    ...
    const getBrand = () => {
        if (values.sub_collection && values.sub_collection !== -1) {
            const brand = find(REFRIGERATOR_AIR_CONDITIONER_TYPE, e => e.name === values.sub_collection)?.brand
    ...
    return (
        <div>
                ...
                <div className="input-area">
                    <div
                        ...
                        <select
                            ...
                            {REFRIGERATOR_AIR_CONDITIONER_TYPE.map(e => (
                    ...
                    <div className="mb-5">
                        ...
                        <div className="text-sm text-gray-400 border border-gray-300
                             ...
                             onClick={() => {
                                 if (document) {
                                     document.getElementById("modal-select-address-10").showModal();
                                 }
                             }}>
            ...
            <SelectAddress id={'modal-select-address-10'} onSubmitAddress={addr => {
