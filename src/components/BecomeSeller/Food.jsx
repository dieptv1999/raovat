...
export default function Food({
    ...
    const getBrand = () => {
        if (values.sub_collection && values.sub_collection !== -1) {
            const brand = find(FOOD_TYPE, e => e.name === values.sub_collection)?.brand
    ...
    return (
        <div>
                ...
                <div className="input-area">
                    ...
                    <div className="mb-5">
                        ...
                        <div className="text-sm text-gray-400 border border-gray-300
                             ...
                             onClick={() => {
                                 if (document) {
                                     document.getElementById("modal-select-address-9").showModal();
                                 }
                             }}>
            ...
            <SelectAddress id={'modal-select-address-9'} onSubmitAddress={addr => {
