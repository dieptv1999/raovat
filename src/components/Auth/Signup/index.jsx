            ...
            <div className="login-page-wrapper w-full py-10">
                <div className="container-x mx-auto">
                    <div className="lg:flex items-center relative">
                        <div
                            className="lg:w-[572px] w-full lg:h-[783px] bg-white flex flex-col justify-center sm:p-10 p-5 border border-[#E0E0E0]">
                                ...
                                <form className="input-area" onSubmit={formik.handleSubmit}>
                                    <div className="input-item mb-5">
                                        <InputCom
                                            ...
                                            inputClasses="h-[50px]"
                                        />
                                        {formik.errors.fullName ? <div className="text-red-500 text-xs mt-0.5">{formik.errors.fullName}</div> : null}
                                    </div>
                                    <div className="input-item mb-5">
                                        <InputCom
                        ...
                        của <span className="text-blue-500">Raovat24h</span>.
                      </span>
                                        </div>
                                    </div>
                        ...
                        Apple ID
                                    ...
                                    <div className="signup-area flex justify-center mt-4">
                                        <div className="text-base text-qgraytwo font-normal inline-flex">
                                            ...
                                            <Link href="/login">
                                                <div className="ml-2 text-qyellow underline cursor-pointer">Đăng nhập
                                                </div>
                                            </Link>
                                        </div>
                                    </div>
