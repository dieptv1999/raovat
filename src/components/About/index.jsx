                        ...
                        <div className="w-full min-h-[665px] lg:flex lg:space-x-12 items-center pb-10 lg:pb-0">
                            ...
                            <div className="content flex-1">
                                ...
                                <p className="text-[15px] text-qgraytwo leading-7 mb-2.5">
                                    Được phát triển bởi một đội ngũ giỏi đến từ chính những con người Việt thuộc Đại học
                                    Bách Khoa Hà Nội.
                                </p>
                        ...
                        <SimpleSlider selector={slider} settings={settings}>
                            <div className="item h-[385px] bg-primarygray sm:px-10 sm:py-9 p-2">
                                <div className="flex flex-col justify-between h-full">
                                    ...
                                    <div className="text-[15px] text-qgraytwo leading-[30px] text-justify line-clamp-6">
                                        Ứng dụng raovat24h.net thực sự rất nhanh và giúp tôi bán được nhiều đồ cũ hơn
                                        hẳn, từ khi ngày nào cũng đăng tin mà vài ngày đã có người mua rồi.
                                    </div>
                                    <div className="flex items-center space-x-2.5 mt-3">
                                        <div className="w-[50px] h-[50px] rounded-full overflow-hidden relative">
                                            <Image
                                                layout="fill"
                                                src={`/assets/images/review-user-2.jpg`}
                                                objectFit={'cover'}
                                                alt="user"
                                            />
                                        </div>
                                        <div>
                                            ...
                                            <p className="text-qgraytwo text-[13px]">Nam Định</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="item h-[385px] bg-primarygray sm:px-10 sm:py-9 p-2">
                                <div className="flex flex-col justify-between h-full">
                                    ...
                                    <div className="text-[15px] text-qgraytwo leading-[30px] text-justify line-clamp-6">
                                        Lướt ứng dụng mỗi ngày tôi săn được rất nhiều đồ cũ gần tôi mà dùng còn rất tốt,
                                        giá đồ cũ thì gần như là rẻ như cho.
                                    </div>
                                    <div className="flex items-center space-x-2.5 mt-3">
                                        <div className="w-[50px] h-[50px] rounded-full overflow-hidden relative">
                                            <Image
                                                layout="fill"
                                                src={`/assets/images/review-user-1.jpg`}
                                                objectFit={'cover'}
                                                quality={100}
                                                alt="user"
                                            />
                                        ...
                                        <div>
                                            ...
                                            <p className="text-qgraytwo text-[13px]">Long An</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="item h-[385px] bg-primarygray sm:px-10 sm:py-9 p-2">
                                <div className="flex flex-col justify-between h-full">
                                    ...
                                    <div className="text-[15px] text-qgraytwo leading-[30px] text-justify line-clamp-6">
                                        Sau khi khách hàng không trả được khoản vay, chúng tôi đều đăng tin bán tài sản
                                        thế chấp của khách hàng như nhà cửa, đất đai, xe cộ, điện thoại trên này và bán
                                        được rất nhanh
                                    </div>
                                    <div className="flex items-center space-x-2.5 mt-3">
                                        <div className="w-[50px] h-[50px] rounded-full overflow-hidden relative">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-qgraytwo text-[13px]">Hà Nội</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
