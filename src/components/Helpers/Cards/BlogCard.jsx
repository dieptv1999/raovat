...
export default function BlogCard({className, datas}) {
    ...
    return (
        <div
            className={`blog-card-wrapper w-full border border-[#D3D3D3] rounded ${
                className || ""
            }`}
        >
            <Link href={datas.link} passHref>
                {/* eslint-disable-next-line @next/next/no-html-link-for-pages */}
                <a href="/" target={'_blank'}>
                    <div className="img w-full h-[340px] relative cursor-pointer">
                        <Image
                            layout="fill"
                            src={datas.cover}
                            alt="blog"
            ...
            <div className="p-[24px]">
                <div className="short-data flex space-x-9 items-center mb-3">
                    ...
                    <div className="flex space-x-1.5 items-center">
            <span>
              <svg fill="#FFBB38" width="24px" height="24px" viewBox="0 0 442.04 442.04"><g id="SVGRepo_bgCarrier"
                                                                                            strokeWidth="0"></g><g
              ...
              {datas.click} Lượt xem
                ...
                <div className="details">
                    ...
                    <p className="text-qgraytwo text-[15px] leading-[30px] line-clamp-1 mb-3">
                        {datas.des}
                    </p>
                    {/* view more btn */}
                    <Link href={datas.link} passHref>
