              ...
              6 Đánh giá
                    ...
                    <div data-aos="fade-up"
                        ...
                        >
                            ...
                            <div
                                className="text-white w-[130px]">{utils.transformPhone(product.contact_phone, showPhone)}</div>
                            <div
                        ...
                        <div className={'inline-flex space-x-2 mt-2'}>
                            <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none"
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    ...
                                    <path d="M10 16H6" stroke="#1C274C" strokeWidth="1.5"
                                          strokeLinecap="round"></path>
                                    <path d="M14 16H12.5" stroke="#1C274C" strokeWidth="1.5"
                                          strokeLinecap="round"></path>
